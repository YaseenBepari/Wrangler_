...
@Override
public Token visitByteSizeArg(RecipeParser.ByteSizeArgContext ctx) {
    String value = ctx.getText(); // e.g., "10MB"
    return new ByteSize(value);
}

@Override
public Token visitTimeDurationArg(RecipeParser.TimeDurationArgContext ctx) {
    String value = ctx.getText(); // e.g., "250ms"
